...
class ProcessShowPelurusanMenuJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        SendTelegramNotificationJob::dispatch($this->chat_id, "Silakan pilih jenis Laporan Pelurusan:", $reply_markup);
    }
}
