        ...
        <div class="flex items-center justify-center min-h-screen">
            <div class="bg-white dark:bg-[#131518] rounded-lg shadow-xl p-6 relative z-20 w-full max-w-md border dark:border-gray-600/40">
                ...
                <div class="mt-4">
                    ...
                    <select wire:model="newStatusId" id="status" class="block w-full rounded-md border border-gray-300 dark:border-gray-600/40 bg-white dark:bg-[#131518] text-gray-900 dark:text-white shadow-sm dark:shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                ...
                <div class="mt-4">
                    ...
                    <textarea wire:model="keterangan" id="keterangan" rows="4" class="block w-full rounded-md border border-gray-300 dark:border-gray-600/40 bg-white dark:bg-[#131518] text-gray-900 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Tambahkan catatan..."></textarea>
                </div>
                
                <div class="mt-6 flex justify-end space-x-4">
                    <button wire:click="closeStatusModal" type="button" class="px-4 py-2 bg-white dark:bg-[#131518] border border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-sm font-medium text-gray-900 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600">
                        Cancel
                    </button>
