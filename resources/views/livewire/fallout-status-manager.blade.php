<div class="p-4 sm:p-6 lg:p-8">
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-base font-semibold leading-6 text-gray-900 dark:text-white">Manage Fallout Statuses</h1>
            <p class="mt-2 text-sm text-gray-700 dark:text-gray-400">Create, edit, and delete Fallout Statuses.</p>
        </div>
    </div>
    ...
    <div class="mt-6 bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
        <form wire:submit.prevent="{{ $isEditing ? 'update' : 'create' }}" class="space-y-4">
            <div>
                <label for="name" class="block text-sm font-medium leading-6 text-gray-900 dark:text-white">Fallout Status Name</label>
                <div class="mt-2">
                ...
                <table class="min-w-full divide-y divide-gray-300 dark:divide-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse ($falloutStatuses as $falloutStatus)
                            <tr>
                                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 dark:text-white sm:pl-0">{{ $falloutStatus->name }}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="2" class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 dark:text-white sm:pl-0 text-center">No Fallout Statuses found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
