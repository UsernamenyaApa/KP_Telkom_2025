<div class="p-4 sm:p-6 lg:p-8">
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-base font-semibold leading-6 text-gray-900 dark:text-white">Manage HD Daman</h1>
            <p class="mt-2 text-sm text-gray-700 dark:text-gray-400">Create new users and manage their "hd-daman" role.</p>
        </div>
    </div>
        ...
        <form wire:submit.prevent="createUser" class="mt-4 space-y-4">
            <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                <div class="sm:col-span-2">
                    ...
                    <input type="text" wire:model="name" id="name" placeholder="e.g., Kahfi Fauzan Habibi" class="block w-full rounded-md border-0 px-3 py-1.5 text-gray-900 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    @error('name') <p class="mt-2 text-sm text-red-600">{{ $message }}</p> @enderror
                </div>
                <div>
                    <label for="nik" class="block text-sm font-medium leading-6 text-gray-900 dark:text-white">NIK</label>
                    <input type="text" wire:model="nik" id="nik" class="block w-full rounded-md border-0 px-3 py-1.5 text-gray-900 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
