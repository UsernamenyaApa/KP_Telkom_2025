        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex items-center space-x-4" x-data="{ openFilter: false }">
                <div class="relative w-64">
                    <input type="text" wire:model.live.debounce.300ms="search" placeholder="Search Incident Ticket or Order ID..." class="w-full pl-4 pr-10 py-2 rounded-md border border-gray-300 dark:bg-[#131518] dark:border-gray-600 dark:text-white focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="relative">
                    ...
                    <div x-show="openFilter" @click.away="openFilter = false" class="absolute right-0 mt-2 w-64 bg-white dark:bg-[#131518] rounded-md shadow-lg z-10">
                        <div class="py-1">
                            ...
                            <div class="px-4 py-2">
                                <label for="orderType" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Order Type</label>
                            ...
                            <div class="px-4 py-2">
                                <label for="falloutStatus" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Status Fallout</label>
                ...
                <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                    <table class="min-w-full divide-y divide-gray-300 dark:divide-gray-700">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-[#131518]">
                            @for ($i = 0; $i < 5; $i++)
                                <tr>
                                    <td class="whitespace-nowrap py-4 pl-4 pr-3 text-center text-sm font-medium text-gray-900 dark:text-white font-istok-web"><div class="h-4 bg-gray-300 dark:bg-[#131518] rounded w-1/2 mx-auto"></div></td>
