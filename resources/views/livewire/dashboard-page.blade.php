<div class="min-h-screen bg-gray-100 dark:bg-gray-900">
            ...
            <div class="flex items-center space-x-6">
                ...
                <div class="flex items-center space-x-4">
                    <div class="flex items-center space-x-2">
                        ...
                        <input type="date" id="selectedDate" wire:model.live="selectedDate" class="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div class="flex items-center space-x-2">
                        <label for="reportType" class="text-gray-700 dark:text-gray-300 text-sm">Report Type:</label>
                        <select id="reportType" wire:model.live="reportType" class="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
    ...
    <div class="p-6 bg-white">
        ...
        <div class="bg-white-500 rounded-lg p-4 mt-6">
