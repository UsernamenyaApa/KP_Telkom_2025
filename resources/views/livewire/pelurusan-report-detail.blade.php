    ...
    <div class="p-4 sm:p-6 lg:p-8">
        <div class="sm:flex sm:items-center">
            ...
            <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none flex items-center space-x-4">
                <a href="{{ route('pelurusan.index', ['date' => $date]) }}" class="block rounded-md bg-white dark:bg-gray-700 px-3 py-2 text-center text-sm font-semibold text-gray-900 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 sm:mt-0">Back to Dashboard</a>
