    ...
    <div class="p-4 sm:p-6 lg:p-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-base font-semibold leading-6 text-gray-900">Pelurusan Report Details</h1>
                <p class="mt-2 text-sm text-gray-700">Details for pelurusan report: {{ $report->pelurusan_code }}</p>
            </div>
            <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                ...
                @endif
                <a href="{{ route('pelurusan.index') }}" class="block rounded-md bg-white px-3 py-2 text-center text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0">Back to Dashboard</a>
            </div>
        </div>
                    ...
                    <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
                        <div class="grid grid-cols-1 sm:grid-cols-2">
                            ...
                            <div class="px-4 py-5 sm:p-6">
                                ...
                                <dl class="mt-5 grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                                    <div class="sm:col-span-1">
                                        <dt class="text-sm font-medium text-gray-500">Status Pelurusan</dt>
                            ...
                            <div class="px-4 py-5 sm:p-6 sm:col-span-2">
                                ...
                                <dl class="mt-5 grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                                    <div class="sm:col-span-2">
                                        <dt class="text-sm font-medium text-gray-500">Keterangan Insiden Pelurusan</dt>
    ...
    <div class="fixed inset-0 z-10 overflow-y-auto">
        ...
        <div class="flex items-center justify-center min-h-screen">
            <div class="bg-white rounded-lg shadow-xl p-6 relative z-20 w-full max-w-md">
                <h3 class="text-lg font-medium text-gray-900">Change Pelurusan Status</h3>
                <div class="mt-4">
