    ...
    <div class="p-4 sm:p-6 lg:p-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                ...
                <p class="mt-2 text-sm text-gray-700 dark:text-white">Details for pelurusan report: {{ $report->pelurusan_code }}</p>
            </div>
            <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none flex items-center space-x-4">
                <a href="{{ route('pelurusan.index', ['date' => $date]) }}" class="block rounded-md bg-white px-3 py-2 text-center text-sm font-semibold text-gray-900 dark:text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0">Back to Dashboard</a>
                    ...
                    <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
                        <div class="grid grid-cols-1 sm:grid-cols-2">
                            ...
                            <div class="px-4 py-5 sm:p-6">
                                ...
                                <dl class="mt-5 grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                                    <div class="sm:col-span-1">
                                        <dt class="text-sm font-medium text-gray-500 dark:text-white">Status Pelurusan</dt>
                            ...
                            <div class="px-4 py-5 sm:p-6 sm:col-span-2">
                                ...
                                <dl class="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-8">
                                    <div>
                                        <dt class="text-sm font-medium text-gray-500 dark:text-white">Keterangan Insiden Pelurusan</dt>
